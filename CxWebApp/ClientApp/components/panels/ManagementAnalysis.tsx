...
export class ManagementAnalysis extends React.Component<RouteComponentProps<{}>, {}> {
    public render() {
        return <div className="row ssgg_contenedor_dev">
            <div className="row">
                <h1 className="ssgg_txt_color_01">Analitica de </h1>
                <h1 className="ssgg_txt_color_01">Gestión Empresarial</h1>
            </div>
